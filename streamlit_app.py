...
option_skills = st.sidebar.multiselect("Skills (Can Select Multiple Choices):", skill_list, ["SQL"], max_selections=100)

selected_skill_list = []
for i, ind_skill in enumerate(option_skills):
    selected_skill_list.append(f"SKILL_{ind_skill[0]}")
